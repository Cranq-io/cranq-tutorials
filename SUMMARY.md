...
* [💪 Building with AI](building-with-ai/README.md)
  * [🗣 Use the OpenAI API for a Voice-Message to JIRA Ticket App](building-with-ai/use-the-openai-api-for-a-voice-message-to-jira-ticket-app.md)
* [🦜 Use the OpenAI API to Build a WhatsApp Voice Messaging Bot](use-the-openai-api-to-build-a-whatsapp-voice-messaging-bot.md)
* [🔧 Toolbox](toolbox/README.md)
  * [👬 The Dictionary Inner Joiner](toolbox/the-dictionary-inner-joiner.md)
  * [❓ Using Environment Variables](toolbox/using-environment-variables.md)
